...
public class DS_House implements Serializable
{
    ...
    // Name of this house (24 chars max - 1 byte/char)
    private String name;

    // ID associated with this house (memory only, in file it's the relative offset to record)
    private int id;

    // House position data for the JGraphX library
    private int x, y;

    // Minimum distance to this house
    private int distance;

    // Has this node been visited
    private boolean visited;

    // Paths that connect this house to other houses
    private DS_GenericList<DS_Path> houses;

	// Shortest path connecting to this house
